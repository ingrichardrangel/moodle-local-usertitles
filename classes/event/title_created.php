...
/**
 * Event triggered when a title is created.
 *
 * @package   local_usertitles
 * @copyright 2026 Richard Rangel
 * @license   https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class title_created extends \core\event\base {
    /**
    ...
    public static function get_name(): string {
        return get_string('eventtitlecreated', 'local_usertitles');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' created the user title with id '{$this->objectid}'.";
    }
